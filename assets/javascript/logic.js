var beatTheOdds = function() {
    $('#screen').html("<div class='col-md-12 beat'>" +
    "<center>" +
    ...
    "<div class='col-md-12 beat'>" +
        ...
        "<h5 class='card-title'>Beat The Odds</h5>" +
...
var simpsonsTrivia = function() {
    $('#screen').html("<div class='col-md-12 simpsons'>" +
    "<center>" +
  ...
  "<div class='col-md-12 simpsons'>" +
    "<div class='card-body portcard'>" +
      "<h5 class='card-title'>Simpsons Trivia</h5>" +
...
var gifSplosion = function(){
    $('#screen').html("<div class='col-md-12 gify'>" +
    "<center>" +
  ...
  "<div class='col-md-12 gify'>" +
    "<div class='card-body portcard'>" +
      "<h5 class='card-title'>GIFSPLOSION</h5>" +
